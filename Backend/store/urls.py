...
from .views import SignInView,CategoryProductsView,SignUpView,ListProductsView,CreateProductView,ProductSearchView,ProductDetailView,DeleteProductView,UpdateProductView
